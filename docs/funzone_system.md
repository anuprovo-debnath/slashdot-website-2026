...
- **External Game Integrations:** The 180px visual bounds act purely as scaled cover images mapped to standard system animations. Playability is decoupled from the iframe body; a dedicated "Play Game" button (`target="_blank"`) intercepts bottom-section clicks routing precisely to `https://play2048.co/`, `https://hextris.io/`, and `https://ellisonleao.github.io/clumsy-bird/` to guarantee absolute frame safety.
